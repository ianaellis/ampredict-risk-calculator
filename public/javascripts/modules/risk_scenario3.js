...
function autoFill_scenario3(){
    ...
    document.getElementById("Weight").value = 149;
    ...
    //BUN = 70
    document.getElementById("blood_nitrogen").value = 20;
    ...
    document.getElementById("platelet_count").value = 385000;
...
export default autoFill_scenario3
